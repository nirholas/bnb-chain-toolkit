...
// 外部链接配置
export const host = 'https://bnb-agents.sperax.click'; // 项目主站地址
export const githubHomepage = 'https://github.com/nirholas/bnb-agents'; // GitHub 仓库地址
...
export const category = [
  'analytics', // Chain analytics & explorer
  'defi', // DeFi protocols
  'development', // BSC development
  'ecosystem', // BNB ecosystem
  'exchange', // Binance exchange
  'gaming', // Blockchain gaming
  'general', // General BNB Chain
  'governance', // Governance & DAOs
  'nft', // NFTs
  'security', // Security & audits
  'storage', // Greenfield storage
