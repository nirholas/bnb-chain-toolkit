...
export function TutorialProgressWidget({ 
  ...
  if (variant === 'compact') {
    return (
      <div className={`bg-white dark:bg-[#0a0a0a] rounded-lg p-4 border border-gray-200 dark:border-gray-700 ${className}`}>
  ...
  // Full variant
  return (
    <div className={`bg-white dark:bg-[#0a0a0a] rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden ${className}`}>
      {/* Header */}
...
function StatCard({ 
  ...
  return (
    <div className="p-3 rounded-lg bg-gray-50 dark:bg-zinc-900/50 text-center">
    ...
    <div
      className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm ${
        isUnlocked
          ...
          : 'bg-gray-100 dark:bg-zinc-900 text-gray-400 dark:text-gray-500'
      }`}
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 p-3 rounded-lg text-left transition-all ${
              isCurrent
                ...
                : 'bg-gray-50 dark:bg-zinc-900/50 border border-gray-200 dark:border-gray-700'
...
export function ProgressBar({
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <div 
        className="flex-1 bg-gray-200 dark:bg-zinc-900 rounded-full overflow-hidden"
        style={{ height }}
      >
        <div
      ...
      {tutorialIds.map((id) => {
        ...
        return (
          <button
            ...
            className="w-full flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-zinc-900/50 border border-gray-200 dark:border-gray-700 hover:border-primary-300 dark:hover:border-primary-600 transition-all text-left"
          >
