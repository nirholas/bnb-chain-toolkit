...
const contributeWays = [
  ...
  },
  {
    ...
    description:
      "Use the agents, MCP servers, and tools in your own projects. 1,100+ tools ready for production.",
    link: "/explore",
...
const projectHighlights = [
  ...
  { quote: "Supports multiple blockchain networks with multi-aggregator DEX, lending, bridges, and x402 payments", name: "Universal Crypto", title: "380+ tools, multi-chain", icon: <Globe className="w-5 h-5" /> },
...
export default function CommunityPage() {
  ...
  useSEO({
    title: "Community",
    description:
      "Join the BNB Chain AI Toolkit community — contribute to 78 agents, 6 MCP servers, and 1,100+ tools.",
    path: "/community",
  });
